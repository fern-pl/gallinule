...
/**
    ...
    Emits are in the format emit(ubyte OP, ubyte SELECTOR = M, ubyte SIZE = 128, ubyte MAP = 1, ubyte PREFIX = 0)
...
public:
    ...
    @("r128", "rm128")
    auto aesdec(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x38, 0xde, dst, src);
    auto vaesdec(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128)) => emit!(0, VEX, 128, M38, 0x66)(0xde, dst, src, stor);
    auto vaesdec(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256)) => emit!(0, VEX, 256, M38, 0x66)(0xde, dst, src, stor);

    auto aesdec128kl(XMM dst, Mem!384 src) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xdd, dst, src);
    auto aesdec256kl(XMM dst, Mem!512 src) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xdf, dst, src);

    @("r128", "rm128")
    auto aesdeclast(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x38, 0xdf, dst, src);
    auto vaesdeclast(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128)) => emit!(0, VEX, 128, M38, 0x66)(0xdf, dst, src, stor);
    auto vaesdeclast(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256)) => emit!(0, VEX, 256, M38, 0x66)(0xdf, dst, src, stor);

    auto aesdecwide128kl(Mem!384 dst) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xd8, dst, ecx);
    auto aesdecwide256kl(Mem!512 dst) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xd8, dst, ebx);

    @("r128", "rm128")
    auto aesenc(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x38, 0xdc, dst, src);
    auto vaesenc(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128)) => emit!(0, VEX, 128, M38, 0x66)(0xdc, dst, src, stor);
    auto vaesenc(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256)) => emit!(0, VEX, 256, M38, 0x66)(0xdc, dst, src, stor);

    auto aesenc128kl(XMM dst, Mem!384 src) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xdc, dst, src);
    auto aesenc256kl(XMM dst, Mem!512 src) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xde, dst, src);

    @("r128", "rm128")
    auto aesenclast(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x38, 0xdd, dst, src);
    auto vaesenclast(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128)) => emit!(0, VEX, 128, M38, 0x66)(0xdd, dst, src, stor);
    auto vaesenclast(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256)) => emit!(0, VEX, 256, M38, 0x66)(0xdd, dst, src, stor);

    auto aesencwide128kl(Mem!384 dst) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xd8, dst, eax);
    auto aesencwide256kl(Mem!512 dst) => emit!(0, NO_REX | FLIP)(0xf3, 0x0f, 0x38, 0xd8, dst, edx);

    @("r128", "rm128")
    auto aesimc(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x38, 0xdb, dst, src);
    @("r128", "rm128")
    auto vaesimc(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, VEX, 128, M38, 0x66)(0xdb, dst, src);

    @("r128", "rm128", "imm8")
    auto aeskeygenassist(RM)(XMM dst, RM src, ubyte imm8) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x66, 0x0f, 0x3a, 0xdf, dst, src, imm8);
    @("r128", "rm128", "imm8")
    auto vaeskeygenassist(RM)(XMM dst, RM src, ubyte imm8) if (valid!(RM, 128)) => emit!(0, VEX, 128, M3A, 0x66)(0xdf, dst, src, imm8);

    /* ====== SHA ====== */

    @("r128", "rm128")
    auto sha1msg1(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x38, 0xc9, dst, src);
    @("r128", "rm128")
    auto sha1msg2(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x38, 0xca, dst, src);
    @("r128", "rm128")
    auto sha1nexte(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x38, 0xc8, dst, src);

    @("r128", "rm128")
    auto sha256msg1(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x38, 0xcc, dst, src);

    @("r128", "rm128", "imm8")
    auto sha1rnds4(RM)(XMM dst, RM src, ubyte imm8) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x3a, 0xcc, dst, src, imm8);

    @("r128", "rm128")
    auto sha256rnds2(RM)(XMM dst, RM src) if (valid!(RM, 128)) => emit!(0, NO_REX | FLIP)(0x0f, 0x38, 0xcb, dst, src);
    ...
    @("r16")
    auto pop(R16 dst) => emit!(0, ENCODED | ENCODED)(0x58, dst);
    static if (!X64)
    @("r32")
    auto pop(R32 dst) => emit!(0, ENCODED | ENCODED)(0x58, dst);
    static if (X64)
    @("r64")
    auto pop(R64 dst) => emit!(0, ENCODED | ENCODED)(0x58, dst);
    ...
    @("r16")
    auto push(R16 dst) => emit!(0, ENCODED | ENCODED)(0x50, dst);
    static if (!X64)
    @("r32")
    auto push(R32 dst) => emit!(0, ENCODED | ENCODED)(0x50, dst);
    static if (X64)
    @("r64")
    auto push(R64 dst) => emit!(0, ENCODED | ENCODED)(0x50, dst);
...
unittest
{
    ...
    auto pfadd(RM641)(R64 o0, RM641 o1) if (valid!(RM641, 64)) => emit!(0, 0, 128, 1, 0)(0x0f, 0x0f, o0, o1, 0x9e);
